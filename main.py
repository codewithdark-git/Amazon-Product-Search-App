...
def extract_product_info(search_results):
    ...
    try:
        ...
        for result in results:
            ...
            if title_element and price_whole_element and price_fraction_element and image_element:
                title = title_element.get_text().strip()
                price = f"${price_whole_element.get_text().strip()}.{price_fraction_element.get_text().strip()}"
        ...
        if page == "Home":
            ...
            if search_query:
                ...
                if search_results:
                    ...
                    st.write(f"Failed to fetch search results for '{search_query}'.")
